/*
	...
	Fecha de entrega: 9 de septiembre de 2025
...
// Variable para manipular el modelo
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 modelTemp = glm::mat4(1.0f); //Temp  //Posición de cada uno de los elementos
