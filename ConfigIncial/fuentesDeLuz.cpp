...
glm::vec3 pointLightPositions[] = {
	...
	glm::vec3(0.0f,0.0f, 0.0f),         //4 fuentes de luz de tipo puntual
	glm::vec3(0.0f,0.0f,  0.0f),
	glm::vec3(0.0f,0.0f, 0.0f)
};
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo Practica 9 - Fuentes de Luz - Luis_Cruz", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 0.2f, 0.2f, 0.5f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.specular"),0.1f, 0.1f, 0.3f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.constant"), 1.0f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.linear"), 0.35f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.quadratic"), 0.85f);
