...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 6 Carga de modelos - Luis_Cruz", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Draw the loaded model //Dibujos del enorno
        ...
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(modelBank));
        bank.Draw(shader);
        ...
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(modelGarbage));
        garbage.Draw(shader);
