...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas Luis_Cruz", nullptr, nullptr);
	...
	//use with Perspective Projection  //vertices adaptados para una proyección en perspectiva 
	float vertices[] = {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, 1.5708f, glm::vec3(0.0f, -12.0f, 0.0f)); // Usamos conversión de grados a radianes
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(3.5f, 0.0f, -0.80f));
		...
		// ---------------------- CUBO 3 -----------------------------
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(7.2f, 0.0f, -2.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.30f, 3.30f, 3.30f));
		...
		// ---------------------- CUBO 4 -----------------------------
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(11.2f, 0.0f, -3.0f));
		...
		// ---------------------- CUBO 5 -----------------------------
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(3.0f, 3.0f, 0.5f));
		...
		//// ---------------------- CUBO 6 ----------------------------- 
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(6.5f, 3.1f, 0.75f));
		model = glm::rotate(model, glm::radians(-18.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(20.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //No se aplica otro giro dado que ya hay uno en "y"
		model = glm::scale(model, glm::vec3(2.5f, 2.5f, 2.5f));
		...
		// ---------------------- CUBO 7 -----------------------------
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(4.75f, 5.5f, 0.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, .0f));
		model = glm::rotate(model, glm::radians(12.0f), glm::vec3(0.0f, 1.0f, .0f));
